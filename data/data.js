...
export const users = [
  {
    ...
    status: (
      <Link href="/main/borrow/list">
        <button className="px-2 py-1 rounded-md text-base text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 font-kanit" style={{ fontFamily: 'Kanit' }}>ขอยืม</button>
      </Link>
    ),
  },
  {
    ...
    role: "Technical Lead",
    status: <span className="text-red-500 font-bold" style={{ fontFamily: 'Kanit' }}>ไม่ว่าง</span>,
  },
  {
    key: "3",
    name: "Jane Fisher",
